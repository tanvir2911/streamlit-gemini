...
def quiz_generator(images, difficulty):
    prompt = f"Generate 3 quizzes in language Bangla and based on the {difficulty}. Make sure to add markdown to differentiate the options. Add correct answers too, after the quiz"
